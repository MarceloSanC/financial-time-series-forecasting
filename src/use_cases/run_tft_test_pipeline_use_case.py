        ...
        *,
        ...
        if test_type == TEST_TYPE_OFAT:
            ...
            result = use_case.execute(
                ...
                resume_policy=str(config.get("resume_policy", "keep_completed")),
                rewind_n=int(config.get("rewind_n", 1)),
                reconcile_orphans=bool(config.get("reconcile_orphans", True)),
                cleanup_failed_or_incomplete=bool(config.get("cleanup_failed_or_incomplete", True)),
                dry_run_cleanup=bool(config.get("dry_run_cleanup", False)),
